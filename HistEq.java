//Ramon Sandoval
//Some code from http://code.google.com/p/hadoop-computer-vision/
...
public class HistEq {
	public static class ImageMapper extends Mapper<LongWritable, BufferedImage, LongWritable
	, LongArrayWritable>{
	...
	public static class HistSumReducer extends Reducer<LongWritable,LongArrayWritable,LongWritable,LongArrayWritable> {
